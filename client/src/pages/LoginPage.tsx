...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden">
      ...
      <svg
        className="pointer-events-none absolute -right-40 -top-40 w-[560px] h-[560px] text-brass-500/[0.05] animate-dial-spin"
        viewBox="0 0 100 100"
        fill="none"
      >
      ...
      <div className="relative w-full max-w-md animate-fade-up">
        <div className="text-center mb-8">
          <p className="ledger-label text-[10px] text-brass-500 mb-2">Members Only</p>
          <h1 className="font-display italic text-4xl font-semibold text-ivory">
            Welcome Back
          </h1>
          <p className="text-vault-300 mt-2 font-mono text-sm">Sign in to your account</p>
        </div>
        ...
        >
          ...
          <div>
            <label htmlFor="login-email" className="ledger-label block text-[10px] text-vault-300 mb-1.5">
              Email
            </label>
            <input
              id="login-email"
          ...
          <div>
            <label htmlFor="login-password" className="ledger-label block text-[10px] text-vault-300 mb-1.5">
              Password
            </label>
            <input
              id="login-password"
        ...
        <p className="text-center text-vault-300 mt-6 text-sm">
          ...
          <Link to="/register" className="text-brass-400 hover:text-brass-300 font-medium transition-colors">
            Sign up
          </Link>
        </p>
      </div>
